...
@interface ADFavoritePageVC ()

@end

@implementation ADFavoritePageVC

- (id)initWithView:(ADView*)someView
{
    if (debugFavoritePageVC) NSLog(@"ADFavoritePageVC initWithView");
    
    self = [super initWithNibName:@"ADFavoritePageVC" bundle:nil];
...
{
    if (debugFavoritePageVC) NSLog(@"onSelectListItem");
...
- (IBAction)onBackBtnClick:(id)sender {
    if (debugFavoritePageVC) NSLog(@"onBackBtnClick");

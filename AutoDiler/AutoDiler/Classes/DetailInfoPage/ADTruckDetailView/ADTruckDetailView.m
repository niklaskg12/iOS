...
@implementation ADTruckDetailView
...
- (void)populateData
{
    ...
    if ([data objectForKey:@"nosivost"] != [NSNull null]) {
        id = [data objectForKey:@"nosivost"];
        self.adCapacity.text = [NSString stringWithFormat:@"%@ kg", id];
    } else {
        self.adCapacity.text = @"";
    }
